...
const COLLECTIONS = [
  ...
  },
  {
    name: "Faith & Freedom",
    tag: "Faith · Liberty",
    desc: "Designs rooted in faith and liberty — quietly bold, made for everyday wear.",
  ...
  },
  {
    name: "Family Legacy",
    tag: "Family · Heirloom",
    desc: "Personalized heirlooms for your family story — names, dates, the moments worth keeping.",
  ...
  },
  {
    ...
    desc: "Celebrating the birthdays that define generations — 30, 50, 70, every one of them.",
  ...
  },
  {
    name: "Good Humor",
    tag: "Humor · Everyday",
    desc: "Because life is better when you laugh a little — playful prints for everyday joy.",
