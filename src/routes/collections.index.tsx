...
const COLLECTIONS = [
  ...
  },
  {
    name: "Roots & Legacy",
    tag: "Family · Heirloom",
    desc: "Personalized family-name designs made to celebrate your family's story.",
  ...
  },
  {
    name: "Faith & Freedom",
    tag: "Faith · Liberty",
    desc: "Christian and patriotic designs for faith, freedom and everyday wear.",
  ...
  },
  {
    ...
    desc: "Milestone birthday designs for 30, 40, 50 and 60. Celebrating the decades that mark generations.",
  ...
  },
  {
    name: "Good Humor",
    tag: "Humor · Everyday",
    desc: "Funny, sarcastic designs for everyday gifting, because life is better with a little humor.",
